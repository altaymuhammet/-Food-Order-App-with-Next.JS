...
import { footerSchema } from "../../schema/adminFooterSchema";
...
const Footer = () => {
  ...
  return (
    <form className="md:px-8 flex-1 lg:mt-0 mt-5">
      ...
      <div className="mt-4 flex justify-between md:items-center md:flex-row flex-col gap-4">
        ...
        <ul className="flex justify-start items-center gap-x-12 flex-1 ml-12">
          {icons.map((icon, index) => (
            <li key={index} className="flex items-center">
              ...
              <button
                ...
                type="button"
              >
                <i className="fa fa-trash text-2xl ml-2 text-primary hover:text-red-600"></i>
              </button>
            </li>
          ))}
        </ul>
